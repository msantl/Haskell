...
LECTURE 9: Custom type classes and standard data types
...
In our definition 'maxAge' does not depend on any value, in other wors 'maxAge'
...
- Define a class 'Nameable' with function
  ...
  "<Name> <Surename>", while for a dog return "<Name> the Dog".
...
(How would a 'foldr' for a rose tree look like? try to generialize from the
above case.)
...
- Using 'foldr' from 'Foldable' class define a function
  ...
  that sums the positive elements in a structure of 't a' type.
