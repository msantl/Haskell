...
But constructors can also be binary, ternary, etc. E.g., (example borrowed from
LYAHFGG):
...
A bit better approach to define the above types:
...
- Define your type 'Vehicle' that can be a 'Car', 'Truck', 
  'Motorcycle', or 'Bicycle'. The first two store a name of the manufacturer
  (String) and horsepower (Int). 
- Write a function 'totalHorsepower' that adds up the horsepower of the
  vehicles, assuming that bicycle's horsepower is 0.3
